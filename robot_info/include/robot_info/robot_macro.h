...
// Used to generate key values for shared memory and semaphore.
...
// robot arm joint names, it must be same as the sdf, 
// "robot_hw_interface/config/robot_hardware.yaml"
...
// Correspond to robot hardware interface in "robot_hw_interface/config/robot_hardware.yaml".
// Used to get ros parameters in "robot_hw_interface/src/robot_hw_control.cpp"
#define ROBOT_ARM_JOINTS  "/robot/arm/joints"

// Correspond to robot hardware interface in "robot_hw_interface/config/robot_controllers.yaml".
...
// Correspond to ros controller manager.
// Used to switch controller in "robot_sdk/src/robot_sdk.cpp".
#define CONTROLLER_MANAGER_SWITCH_CONTROLLER  "/controller_manager/switch_controller"
...
// Used to subscribe robot joint states in "robot_sdk/src/robot_sdk.cpp".
#define ROBOT_ARM_JOINT_STATES  "/joint_states"
